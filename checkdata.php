...
<!--                                                <th>#</th>
                                                <th>Flag</th>-->
                                            <?php } elseif ($getPosID == '2' || $getPosID == '6') {
                                                ?>                                                
                                                <!--<th>Flag</th>-->
...
//
//                                        $query = mysql_query("SELECT id,DATE_FORMAT(tanggal_order,'%d %b %Y') pesan,flag, no_sms, pemesan, nama_proyek, item, qty, satuan, DATE_FORMAT(tanggal_proses,'%d %b %Y') proses, no_po, vendor, DATE_FORMAT(estimasi,'%d %b %Y') kirim, cp,request,  harga FROM purchasing where MONTH(tanggal_order)>='$MonAgo' and MONTH(tanggal_order)<='$dateMonNow' ORDER BY tanggal_order DESC, no_sms DESC");
...
//                                                if ($result['no_po'] !== "") {
//                                                    echo "<td><a href='index.php?pic=checkdata&page=checkout&id=$result[id]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Update To Process 3'><span class='glyphicon glyphicon-pencil'></span></a>";
//                                                } else {
//                                                    echo "<td><a href='index.php?pic=checkdata&page=update&id=$result[id]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Update To Process 2'><span class='glyphicon glyphicon-pencil'></span></a>";
//                                                }
//                                                if ($getPosID == '1') {
//                                                    echo "<a href='index.php?pic=checkdata&page=delete&DeLid=$result[id]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Delete' onClick=\"return confirm('Are you sure to delete this the data?');\"><span class='glyphicon glyphicon-trash'></span></a>";
//                                                }
//                                                echo "<a href='index.php?pic=checkdata&page=print&id=$result[no_sms]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Print'><span class='glyphicon glyphicon-print'></span></a></td>";
//                                                echo "<td>$result[flag]</td>";
//                                            } else if ($getPosID == '2' || $getPosID == '6') {
//                                                echo "<td>$result[flag]</td>";
//                                            } else if ($getPosID == '5') {
//                                                echo "<td><a href='index.php?pic=checkdata&page=print&id=$result[no_sms]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Print'> <span class='glyphicon glyphicon-print'></span></a></td>";
//                                            }
//                                            echo "    
//                                                    <td>$result[pesan]</td>    
//                                                    <td>$result[no_sms]</td>
                                                                ...
                                                                while ($arrPO = mysql_fetch_array($dataPO)) {
                                                                    ...
                                                                    if (!empty($arrPO)) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <input type="text" name="tempo" value="<?php echo $arrPO['tanggal_tempo']; ?>" class="form-control">
                                                                            </td>
                                                                            <td>
                                                                                <?php
                                                                                ...
                                                                                <select name="location" class="form-control">
                                                                                    <?php while ($row = mysql_fetch_array($qlocRest)) { ?>
                                                                            ...
                                                                            <td align=center><input type="text" name="satuan" value="<?php echo $arrPO['satuan']; ?>"  class="form-control"></td>
                                                                            <td><input type="text" value="<?php echo $arrPO['harga']; ?>" id="harga" class="radio1 form-control" name="harga" style="text-align: right" placeholder="0"></td>
                                                                            <!--onkeyup="formatangka(this);autoComplete(this);"-->
                                                                            <td><input type="text" name="ppn" value="<?php echo $arrPO['ppn']; ?>" class="form-control">
                                                                        ...
                                                                        <!--<td><input type="text" class="form-control" id="subtotal" name="total" value="<?php echo $arrPO['total']; ?>" placeholder="0" style="text-align: right" <?php echo $readonly; ?>></td>
...
//                
            ...
            $DeLid = $_GET['DeLid'];
            $delete = mysql_query("delete from purchasing where id='$DeLid'");
            if ($delete) {
