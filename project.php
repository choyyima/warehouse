                                    ...
                                    <tbody>
                                        ...
                                        while ($result = mysql_fetch_array($query)) {
                                            ...
                                            echo"<tr>
                                                    ...
                                                    <td>$status</td>
                                                    <td><a href='index.php?pic=project&page=update&id=$result[id]' class='btn btn-sm' data-toggle='tooltip' data-placement='bottom' title='Edit'><span class='glyphicon glyphicon-pencil'></span></a>
                                        ...
                                        <div class="tab-pane active in">
                                            <form action="<?php $_SERVER['PHP_SELF']; ?>" name="form" method="post" id="tab">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Project Name / Nama Proyek</label>
                                                        <input type="text" name="nama_project" placeholder="Project Name / Nama Project" class="form-control" value="<?php echo $rows['nama_project']; ?>">
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Address / Alamat</label>
                                                        <textarea name="alamat" placeholder="Address" class="form-control"> <?php echo $rows['alamat']; ?></textarea>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Phone / Telepon</label>
                                                        <input type="text" name="phone" placeholder="08xxxxxxxxx" class="form-control"  value="<?php echo $rows['telepon']; ?>" >
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status</label>
                                                        <select name="status" class="form-control">
                                                            <option value="1" <?php echo $checked ?>>Active / Aktif</option>
                                                            <option value="2" <?php echo $checkeds ?>>Done / Selesai</option>
                                                        </select>
                                                    </div>
                                                    <div class="form-group">
